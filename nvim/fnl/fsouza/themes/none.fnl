...
(fn basics [ns]
  (vim.api.nvim_set_hl ns "CursorColumn" {:bg colors.lighter_gray})
  (vim.api.nvim_set_hl ns "CursorLine" {:bg colors.lighter_gray})
  (vim.api.nvim_set_hl ns "CursorLineNr" {:bold true :bg colors.lighter_gray})
  (vim.api.nvim_set_hl ns "Directory" {:fg colors.dark_gray})
  (vim.api.nvim_set_hl ns "LineNr" {:bg colors.lighter_gray})
  (vim.api.nvim_set_hl ns "MatchParen" {:bg colors.light_gray})
  (vim.api.nvim_set_hl ns "Normal" {:fg colors.black})
  (vim.api.nvim_set_hl ns "Floating" {:bg colors.light_gray :fg colors.black})
  (vim.api.nvim_set_hl ns "Pmenu" {:bg colors.gray})
  (vim.api.nvim_set_hl ns "SignColumn" {:bg colors.lighter_gray :fg colors.black})
  (vim.api.nvim_set_hl ns "SpecialKey" {:fg colors.dark_gray})
  (vim.api.nvim_set_hl ns "SpellBad" {:fg colors.red})
  (vim.api.nvim_set_hl ns "TabLine" {:bg colors.gray :fg colors.dark_gray})
  (vim.api.nvim_set_hl ns "TabLineFill" {:bg colors.gray})
  (vim.api.nvim_set_hl ns "TabLineSel" {:fg colors.dark_gray})
  (vim.api.nvim_set_hl ns "ErrorMsg" {:bg colors.red :fg colors.white})
  (vim.api.nvim_set_hl ns "WarningMsg" {:fg colors.brown})
  (vim.api.nvim_set_hl ns "Folded" {:bg colors.lighter_gray})
  (vim.api.nvim_set_hl ns "FoldColumn" {:bg colors.lighter_gray})
